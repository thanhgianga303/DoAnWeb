...
<p style="font-size:20px">(Bảo hành sản phẩm là khắc phục sự cố hư hỏng, sự cố kỹ thuật xảy ra do lỗi của nhà sản xuất.)</p><br>
<p style="color:red;font-size:20px">1. Thời gian bảo hành.</p><br>
<p style="font-size:15px">1 tháng kể từ ngày nhận hàng.</p><br>
<p style="color:red;font-size:20px">2. Điều kiện bảo hành.</p><br>
<p style="font-size:15px">Các sản phẩm bảo hành phải còn mới, không bị dơ bẩn.<br>
Sản phẩm bị thủng, rách… do lỗi của nhà sản xuất.<br>
Sản phẩm bị in màu lem, bay màu, in sai quy cách.</p><br>
<p style="color:red;font-size:20px">3. Những trường hợp không được bảo hành.</p><br>
<p style="font-size:15px"Sử dụng sản phẩm sai với hướng dẫn sử dụng.<br>
...
<p style="color:red;font-size:20px">4. Hình thức bảo hành.</p><br>
<p style="font-size:15px"Thu hồi và sản xuất mới những sản phẩm không đạt yêu cầu.<br>
Sửa lại những sản phẩm bị lỗi nhỏ.</p><br>
<p style="color:red;font-size:20px">5. Địa điểm nhận bảo hành.</p><br>
<p style="font-size:15px">Shop thời trang CHANEL<br><br>
...
<p style="font-size:20px;color:red;">1. Thời gian giao hàng.<br>
    Shop áp dụng chính sách giao hàng như sau:</p><br>
<p style="font-size:15px">Khu vực giao hàng:<br> 
    Nội thành:                                   1 – 2 ngày( trừ chủ nhật)<br>
    Ngoại thành:                                2 – 3 ngày (trừ chủ nhật)<br>
</p>
<p  style="font-size:20px;color:red;">2. Phí giao hàng</p>
<p  style="font-size:10px">Đối với KH trong thành phố,Shop sẽ giao hàng miễn phí với đơn hàng trị giá trên 2.000.000 VNĐ.<br>
...
Đối với khách hàng ở các tỉnh, Công ty sẽ hỗ trợ mang hàng ra bến xe, chuyển theo địa chỉ khách hàng yêu cầu. Nhưng phí gửi hàng với nhà xe, khách hàng thanh toán với nhà xe.</p></div>`
    document.getElementById("baohanh").innerHTML=s;}
        ...
        { s=s+`<div style="text-align:left"><p style="font-size:40px"><h1>Chính sách đổi hàng</h1></p><br>
<p style="font-size:20px;color:red">Loại sản phẩm áp dụng:</p><p style="font-size:15px"> Sản phẩm nguyên giá.</p><br>
<p style="font-size:20px;color:red">Thời gian đổi sản phẩm:<br>
...
- Ngày mua: Là ngày ghi trên hóa đơn bán hàng.<br></p>
<p style="font-size:20px;color:red">Điều kiện ĐỔI sản phẩm:</p>

<p style="font-size:15px">- Sản phẩm chưa sử dụng còn nguyên tem mác, hóa đơn và còn mới 100%<br>
...
- Hàng hóa được xác định nguồn gốc mua tại Hệ thống showroom Aristino và kênh bán hàng online của Aristino<br></p>

<p style="font-size:20px;color:red">Sản phẩm KHÔNG nhận đổi:</p>

<p style="font-size:15px">- Sản phẩm đã sử dụng. Sản phẩm có mùi nước hoa, hóa mỹ phẩm.<br>
...
<p style="font-size:20px;color:red">Giá trị đổi hàng:</p>
<p style="font-size:15px">
...
<p style="font-size:20px;color:red">Quy trình xử lý thủ tục đổi hàng:</p>
<p style="font-size:15px">
...
<p style="font-size:20px;color:red"> Quy định về tính phí vận chuyển:</p>
<p style="font-size:15px">
