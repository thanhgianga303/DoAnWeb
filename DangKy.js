...
//lấy listUser xong đưa về dạng oject
...
//lấy user ra đưa về oject
function getUser(){
	return JSON.parse(window.localStorage.getItem("User"))||[];
}
//đưa u từ oject về chuỗi đưa vào local =>User
function setUser(u){
	window.localStorage.setItem("User", JSON.stringify(u));
}
//Luu thông tin những tài khoản đã đăng kí vô local
